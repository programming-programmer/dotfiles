 ...
 * Basically harpoon from ThePrimagen™ 
#+begin_src emacs-lisp
  (use-package dogears)
#+end_src
...
#+begin_src emacs-lisp
  ...
  "m" '(dogears-remember :which-key "dogears remember")
...
*** Dogears (Bookmark Nav)
#+begin_src emacs-lisp
  "g" '(nil :which-key "dogears")
  "gg" '(dogears-go :which-key "dogears go")
  "gb" '(dogears-back :which-key "dogears back")
  "gf" '(dogears-forward :which-key "dogears forward")
  "gl" '(dogears-list :which-key "dogears list")
  "gs" '(dogears-sidebar :which-key "dogears sidebar")
#+end_src
...
#+begin_src emacs-lisp
  ...
  (general-def
    ...
    "C-e" '(dogears-go :which-key "dogears go")
    )
#+end_src
