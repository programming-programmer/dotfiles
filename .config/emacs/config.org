...
#+begin_src emacs-lisp
  (load "/home/undefined/.config/emacs/lisp/funcs.el")
  (load "/home/undefined/.config/emacs/lisp/var.el")
#+end_src

** PATH Variables
 * Added because langtool requires java and for some reason?? java isn't with
emacs's path as well
#+begin_src emacs-lisp
    ...
    (concat
     ...
     (with-temp-buffer
       (insert-file-contents
        "/home/undefined/.config/emacs/org/outlook_email.css")
       (buffer-string))
     "/*]]>*/-->\n"
     "</style>\n"))
...
#+begin_src emacs-lisp
  (setq langtool-language-tool-jar "/opt/LanguageTool-6.2/languagetool-commandline.jar")
...
** Writeroom
 * Might change to olivetti but I think I'm fine for now
#+begin_src emacs-lisp
...
*** Nyan Mode
 * Nyan mode baby!
 * Should add something that disables it when in a terminal but since
   emacsclient is "connected" it nullifies it when I have a terminal and gui
...
#+begin_src emacs-lisp
  ("s" "school note" plain (file "/home/undefined/.config/emacs/org/school_template.org")
   :if-new (file+head "${slug}.org" "#+title: ${title}\n")
   :unnarrowed t)
#+end_src
...
***** Task
#+begin_src emacs-lisp
   ("t" "Todo" entry (file+headline "/home/undefined/Notes/refile.org" "Tasks")
    "* TODO  %?\n ")
#+end_src
...
#+begin_src emacs-lisp
   ...
   ("T" "Todo for today" entry (file+headline "/home/undefined/Notes/refile.org" "Tasks")
    "* TODO  %?\nDEADLINE: %<<%Y-%m-%d>>")
#+end_src

***** Notes
#+begin_src emacs-lisp
   ("n" "Notes" entry (file+headline "/home/undefined/Notes/refile.org" "Notes")
  "* %?  \n ")
#+end_src

***** Email
#+begin_src emacs-lisp
("e" "Email" entry (file+headline "/home/undefined/Notes/refile.org" "Emails")
   "* To: %? \n")
#+end_src
...
***** Errand
#+begin_src emacs-lisp
   ("E" "Errand" entry (file+headline "/home/undefined/Notes/personal.org" "Tasks")
    "* TODO  %?\n ")
#+end_src
...
***** Movie
#+begin_src emacs-lisp
   ("wm" "Movie" entry (file+headline "/home/undefined/Notes/watchlist.org" "Movies")
    "* TODO  %?\n ")
#+end_src

***** Show/Anime
#+begin_src emacs-lisp
   ("ws" "Show / Anime" entry (file+headline "/home/undefined/Notes/watchlist.org" "Shows / Anime")
    "* TODO  %?\n ")
#+end_src

***** Book
#+begin_src emacs-lisp
   ("wb" "Book" entry (file+headline "/home/undefined/Notes/watchlist.org" "Not Started")
    "** TODO  %?\n ")
#+end_src
